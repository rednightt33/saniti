...
18. [`apps/market-ai-backend/README.md`](apps/market-ai-backend/README.md) — **deactivated on `dev` since 2026-09-25 (legacy, kept for history and rollback)**: private analysis API, structured tools, independent limits, progressive exposure, and audit lifecycle.
19. [`apps/market-query-sandbox/README.md`](apps/market-query-sandbox/README.md) — **deactivated on `dev` since 2026-09-25 (legacy, kept for history and rollback)**: isolated custom joins, windows, and descriptive transformations over immutable bounded raw/Feature snapshots, without database credentials.
20. [`apps/market-analytics-worker/README.md`](apps/market-analytics-worker/README.md) — **deactivated on `dev` since 2026-09-25 (legacy, kept for history and rollback)**: isolated statistical validation over immutable bounded raw/Feature snapshots, without database credentials.

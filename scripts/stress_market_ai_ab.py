...
QUESTIONS = [
    ...
    ("F4", "Pada tanggal terbaru Feature broker rolling, untuk BBCA di Regular board, siapa 5 broker dengan net_value_20d tertinggi? Sertakan broker_type, broker_classification, buy_day_ratio_20d, buy_share_active_days_20d, net_value_zscore_20d, dan largest_buy_day_share_20d. Nilai apakah akumulasinya persisten atau didominasi satu hari, dan jelaskan keterbatasan klasifikasi broker saat ini."),
